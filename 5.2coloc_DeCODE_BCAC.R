...
for (i in same_exp_metasig) {
  ...
  setwd("M:/pQTL_BC_MR/7.2coloc_DeCODE_BCAC/")
...
setwd("M:/pQTL_BC_MR")
save(all_coloc_results,file = '5.2coloc_DeCODE_BCAC.rdata')
fwrite(all_coloc_results,file ='5.2coloc_DeCODE_BCAC.csv',row.names = T) 
