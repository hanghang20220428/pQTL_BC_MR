...
library(data.table)
setwd("M:/pQTL_BC_MR")
load('deCODE_as_expo_0.1_100kb/17441_4_ALPI_Alkaline_phosphatase__intestine.rdata')

setwd("H:/2 data/GWAS data/FinnR9_all_outcome_rdata/")
...
save(AllOR,file = '4.1DeCODE_ALPI_phewas_MR.rdata')
write.csv(AllOR,file = '4.1DeCODE_ALPI_phewas_MR.csv')
...
save(AllOR_NOhete,file = '4.1DeCODE_ALPI_phewas_MR_BFR_NOhete.rdata')
