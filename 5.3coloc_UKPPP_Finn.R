...
for (i in same_exp_metasig) {
  ...
  QTLdata <- QTLdata[QTLdata$SNP %in% sameSNP, ]
  GWASdata <- GWASdata[GWASdata$SNP %in% sameSNP, ]
  ...
  setwd("M:/pQTL_BC_MR/7.3coloc_UKPPP_Finn/")
...
setwd("M:/pQTL_BC_MR")
save(all_coloc_results,file = '5.3coloc_UKPPP_Finn.rdata')
fwrite(all_coloc_results,file ='5.3coloc_UKPPP_Finn.csv',row.names = T) 
